...
StreamBlock_Down::StreamBlock_Down()
{
	...
	mainAnim->SetClipEvent(bind(&StreamBlock_Down::OnAnimClipEvent, this), ANIM_CLIP_IDX);
	...
	endAnim->SetClipEvent(bind(&StreamBlock_Down::OnAnimClipEvent, this), ANIM_CLIP_IDX);
