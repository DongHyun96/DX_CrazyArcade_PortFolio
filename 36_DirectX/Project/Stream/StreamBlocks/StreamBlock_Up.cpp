...
StreamBlock_Up::StreamBlock_Up()
{
	...
	mainAnim->SetClipEvent(bind(&StreamBlock_Up::OnAnimClipEvent, this), ANIM_CLIP_IDX);
	...
	endAnim->SetClipEvent(bind(&StreamBlock_Up::OnAnimClipEvent, this), ANIM_CLIP_IDX);
