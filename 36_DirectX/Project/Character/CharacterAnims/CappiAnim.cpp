	...
	:CharacterAnim(parent)
{
	...
	for (UINT i = 0; i < 4; i++)
	{
		wstring path = L"InGame/Characters/Cappi/Win/" + to_wstring(i) + L".png";
	...
	for (UINT i = 0; i < 5; i++)
	{
		wstring path = L"InGame/Characters/Cappi/CappiDownWalk_" + to_wstring(i) + L".png";
	...
	for (UINT i = 0; i < 5; i++)
	{
		wstring path = L"InGame/Characters/Cappi/CappiUpWalk_" + to_wstring(i) + L".png";
		frames.push_back(new Frame(idleSize, path));
	}
	...
	for (UINT i = 0; i < 5; i++)
	{
		wstring path = L"InGame/Characters/Cappi/CappiLeftWalk_" + to_wstring(i) + L".png";
		frames.push_back(new Frame(idleSize, path));
	}
	...
	for (UINT i = 0; i < 5; i++)
	{
		wstring path = L"InGame/Characters/Cappi/CappiRightWalk_" + to_wstring(i) + L".png";
		frames.push_back(new Frame(idleSize, path));
	}
	...
	for (UINT i = 0; i < 4; i++)
	{
		wstring path = L"InGame/Characters/Cappi/Bubble/Cappi bubble " + to_wstring(i + 1) + L".png";
	...
	for (UINT i = 0; i < 5; i++)
	{
		wstring path = L"InGame/Characters/Cappi/Bubble/Cappi bubble dead " + to_wstring(i + 1) + L".png";
		frames.push_back(new Frame(bubbleSize, path));
	}
	...
	for (UINT i = 0; i < 3; i++)
	{
		wstring path = L"InGame/Characters/Cappi/Bubble/Cappi bubble saved " + to_wstring(i + 1) + L".png";
		frames.push_back(new Frame(bubbleSize, path));
	}
	...
	{
		vector<Frame*> frames{};
		wstring path = L"InGame/Characters/Cappi/Space" + to_wstring(i) + L".png";
	...
	for (UINT i = 0; i < 4; i++)
	{
		...
		for (UINT j = 0; j < 2; j++)
		{
			wstring path = L"InGame/Characters/Cappi/Owl" + to_wstring(i) + to_wstring(j) + L".png";
			frames.push_back(new Frame(spaceSize, path));
		}
	...
	{
		vector<Frame*> frames{};
		wstring path = L"InGame/Characters/Cappi/Turtle" + to_wstring(i) + L".png";
		frames.push_back(new Frame(spaceSize, path));
