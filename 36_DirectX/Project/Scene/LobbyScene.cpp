...
void LobbyScene::Render()
{
	...
	{
	case VILLAGE:
		FONT->RenderText(L"빌리지 10", "BazziFontBold50", Util::ConvertDxPosToAPIPos({1694, 350}));
		break;
	case FOREST:
		FONT->RenderText(L"포레스트 07", "BazziFontBold50", Util::ConvertDxPosToAPIPos({ 1694, 350 }));
		break;
	case FACTORY:
		FONT->RenderText(L"팩토리 07", "BazziFontBold50", Util::ConvertDxPosToAPIPos({ 1694, 350 }));
		break;
	/*case TEST_FIELD:
